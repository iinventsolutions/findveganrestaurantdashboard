...
const MenuEditForm = () => {
    ...
    const [dishName, setDishName] = useState(menuInitialState?.name || "")
    const [description, setDescription] = useState(menuInitialState?.description || "")
    const [price, setPrice] = useState(menuInitialState?.price || "")
    ...
    const handleSubmit = async (e) => { 
     ...
     useEffect(() => {
        DataStore.query(Dish, id).then(setMenuInitialState)
        console.log("food", menuInitialState)
     }, [])
